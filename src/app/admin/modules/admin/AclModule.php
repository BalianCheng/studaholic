 ...
 */
namespace app\admin\modules\admin;
...
class AclModule extends Module
{
     ...
     * @var string 行为表
     */
    protected $t_behavior = 'acl_behavior';


    function __construct()
    {
        parent::__construct();
        $this->t_role = $this->getPrefix($this->t_role);
        $this->t_acl_menu = $this->getPrefix($this->t_acl_menu);
        $this->t_behavior = $this->getPrefix($this->t_behavior);
    }
